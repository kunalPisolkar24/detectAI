...
export const AnalysisCard = ({ result }: AnalysisCardProps) => {
  ...
  return (
    <m.div
      ...
      className={cn(
        "w-full max-w-[400px] overflow-hidden rounded-2xl border shadow-sm transition-all",
      ...
      <div className="p-4 sm:p-5 flex flex-col gap-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex flex-col">
            <span className={cn("text-[10px] font-bold uppercase tracking-widest opacity-50", inter.className)}>
              Analysis Model
            </span>
