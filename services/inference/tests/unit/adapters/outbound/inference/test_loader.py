...
def test_loader_parses_json_provider_env(mock_loader_env):
...
def test_loader_warns_on_gpu_fallback(mock_loader_env, mocker):
    ...
    loader = HuggingFaceLoader("./cache", providers="CUDAExecutionProvider,CPUExecutionProvider")
    loader.load("spark")
