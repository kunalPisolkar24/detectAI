...
export const ChatNav = () => {
  ...
  return (
    <motion.div
      className={cn(
        "w-full fixed top-0 z-40 left-0 right-0 transition-all duration-300 md:relative",
        theme === "dark"
          ? "bg-black/80 backdrop-blur-md shadow-[0_2px_10px_rgba(0,0,0,0.3)] md:bg-transparent md:backdrop-blur-none md:shadow-none"
          : "bg-white/80 backdrop-blur-md shadow-[0_2px_10px_rgba(0,0,0,0.1)] md:bg-transparent md:backdrop-blur-none md:shadow-none"
      )}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
