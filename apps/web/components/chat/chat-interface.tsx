...
import { ArrowUp, RotateCcw, Plus, BotIcon, Image } from "lucide-react";
    ...
    <div className="flex h-screen flex-col bg-background text-foreground">
                    ...
                    >
                      ...
                      <p
                        className={`text-foreground ${
                          ...
                          "Error: Server is likely down"
                            ? "bg-red-950 p-2 text-red-300 rounded-md"
                            : ""
                        }`}
                      >
      ...
      <div className="w-full p-4 fixed bottom-16 bg-background">
        <div className="relative max-w-3xl mx-auto">
          <div className="flex items-center bg-background rounded-3xl shadow-lg pb-3 border border-gray-400 dark:border-muted ">
            <ScrollArea className="w-full">
              <div className="px-4 pt-4 outline-none border-none w-full rounded-3xl">
                <Textarea
                  ...
                  className="resize-none w-full min-h-[50px] max-h-[210px] overflow-y-auto"
                />
            ...
            <div className="relative flex self-end gap-2 pr-4 mt-4 bottom-[20px] md:bottom-[10px]">
