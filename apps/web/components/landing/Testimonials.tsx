...
//     <section
//       id="testimonials"
//       className="w-full flex flex-col items-center justify-center py-12 mb-10 overflow-hidden px-6 xs:px-8 sm:px-0 sm:x-8 lg:mx-auto transition-colors duration-300"
//     >
//       <motion.div
//         initial={{ opacity: 0, y: -20 }}
//         animate={{ opacity: 1, y: 0 }}
