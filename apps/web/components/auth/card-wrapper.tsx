...
const merriweather = Merriweather({
  ...
  weight: ['400', '700'], // Specify weights needed (400=regular, 700=bold)
});
    ...
    <div className="flex min-h-screen">
      ...
      >
        ...
        <motion.div
          ...
          className="absolute bottom-10 left-10 z-10 w-[90%]"
        >
          {/* Apply the Merriweather font class here and update text */}
          <blockquote className={cn("space-y-2", merriweather.className)}> {/* <--- Apply font class */}
            <p className="text-md tracking-[0.5px]">
              {/* Updated, concise text */}
              “Detect AI streamlined our workflow by improving AI text detection, saving time & content authenticity. This lets us focus on creating valuable, original material.”
            </p>
            <footer className="text-sm">Bhaskar P.</footer>
          </blockquote>
        </motion.div>
