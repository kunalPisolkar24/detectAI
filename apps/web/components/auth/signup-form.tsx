...
import { Eye, EyeOff, User, Mail, Lock, AlertCircle } from "lucide-react"; // Import icons
...
export const SignupForm = () => {
  ...
  const handleTurnstileVerify = (token: string) => {
    ...
    setFormError(null); // Clear error on new verification
  };
  ...
  const onSubmit = async (data: z.infer<typeof SignupSchema>) => {
    ...
    try {
      ...
      // --- Verify Turnstile Token (Backend Call) ---
      ...
      if (signInResult?.error) {
        setFormError("Sign in failed after registration. Please try logging in.");
    ...
    >
      <Form {...form}>
        ...
        <motion.form
          ...
          className="space-y-5" // Consistent spacing
                ...
                <FormControl>
                   <div className="relative flex items-center">
                      <Input
                        ...
                        placeholder="••••••••"
                         className={cn(
                          "pl-3 pr-10 py-2.5 h-11 w-full text-sm", // Added w-full
                          theme === "dark"
                           ? "bg-zinc-950/60 border-white/20 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30"
                           : "bg-white border-black/20 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30",
                          "transition-colors duration-200"
